# -*- coding: utf-8 -*-
"""Supervised_Regression_SalaryPrediction.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1fCPUy_2LSJq8iSDczbQnvOxLb1LXcjFG
...
plt.title('Random Forest Regressor: Test Data vs Test Prediction')
plt.xlabel('Feature')
plt.ylabel('Target')
plt.legend()
plt.grid(True)
